...
//********** Variables ************************************************************
const int led0 = 7;          // donar nom al pin 5 de l’Arduino
const int led1 = 8;          // donar nom al pin 6 de l’Arduino
const int led2 = 9;          // donar nom al pin 7 de l’Arduino
const int led3 = 10;          // donar nom al pin 8 de l’Arduino
const int led4 = 11;          // donar nom al pin 9 de l’Arduino
const int led5 = 12;         // donar nom al pin 10 de l’Arduino
